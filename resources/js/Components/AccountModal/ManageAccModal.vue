                ...
                <div class="modal-body">
                    <form @submit.prevent="saveAccount">
                        ...
                        <div class="mb-4">
                            ...
                            <p v-if="fields.password_confirmation && !passwordMatch" class="text-red-600">
            ...
            saveAccount() {
              axios.get(`/check-user-exists/${this.fields.email}`).then((response) => {
                if (response.data.exists) {
                  ...
                  if (this.fields.role === '1' || this.fields.role === '2') {
                    ...
                    if (this.fields.role === '2' && !this.areAnyCheckboxesChecked()) {
                      ...
                      return; // Do not proceed with saving if no checkbox is checked for Librarian
                    }
